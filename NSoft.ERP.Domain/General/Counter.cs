...
namespace NSoft.ERP.Domain.General
{
    public class Counter : BaseEntity
    {
        ...
        public bool IsUSBDisplay { get; set; }
        public bool IsCOMDisplay { get; set; }
        ...
        public bool IsSalesmanPopupOnSubtotal { get; set; }

        public bool IsPopupPrintconfirmationConfirmation { get; set; }
