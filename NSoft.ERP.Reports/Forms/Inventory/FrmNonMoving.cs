...
{
    public partial class FrmNonMoving : FrmBaseReport
    {
        public FrmNonMoving()
        {
            InitializeComponent();
        ...
        public override void View()
        {
            try
            {
                ...
                RptItemWiseNonMoving rptItemWiseNonMoving = new RptItemWiseNonMoving();
                if (txtItemCodeFrom.Text == string.Empty && txtItemCodeTo.Text == string.Empty)
                {
                    rptItemWiseNonMoving.SetDataSource(salesService.GetItemWiseNonMovingDetails(locationId, dateFrom, dateTo));
                }
                else
                {
                    rptItemWiseNonMoving.SetDataSource(salesService.GetItemWiseNonMovingDetails(locationId, dateFrom, dateTo, codeFrom, codeTo));
                }
                rptItemWiseNonMoving.SummaryInfo.ReportTitle = this.Text;
                if (chkAllLocations.Checked)
                { rptItemWiseNonMoving.DataDefinition.FormulaFields["Location"].Text = "'All Locations'"; }
                else
                { rptItemWiseNonMoving.DataDefinition.FormulaFields["Location"].Text = "'" + cmbLocation.Text.Trim() + "'"; }
                rptItemWiseNonMoving.DataDefinition.FormulaFields["DateFrom"].Text = "'" + dtpDateFrom.Text + "'";
                rptItemWiseNonMoving.DataDefinition.FormulaFields["DateTo"].Text = "'" + dtpDateTo.Text + "'";
                rptItemWiseNonMoving.DataDefinition.FormulaFields["LoginUsername"].Text = "'" + Common.LoggedUserName + "'";
                rptItemWiseNonMoving.DataDefinition.FormulaFields["LoginLocation"].Text = "'" + Common.LoggedLocation + "'";
                rptItemWiseNonMoving.DataDefinition.FormulaFields["CompanyName"].Text = "'" + Common.CompanyName + "'";
                rptItemWiseNonMoving.DataDefinition.FormulaFields["Address"].Text = "'" + Common.Address + "'";
                frmReportViewer.crystalReportViewer.ReportSource = rptItemWiseNonMoving;
