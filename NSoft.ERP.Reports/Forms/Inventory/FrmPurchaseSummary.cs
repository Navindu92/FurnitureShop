...
{
    public partial class FrmPurchaseSummary : FrmBaseReport
    {
        ...
        public override void View()
        {
            try
            {
                ...
                RptItemWisePurchaseSummary rptItemWisePurchaseSummary = new RptItemWisePurchaseSummary();
                rptItemWisePurchaseSummary.SummaryInfo.ReportTitle = this.Text;
                DataSet dtPurchaseSummary = purchaseService.GetPurchaseSummary(locationId, dateFrom, dateTo, codeFrom, codeTo);
                rptItemWisePurchaseSummary.SetDataSource(dtPurchaseSummary.Tables[0]);

                decimal subTotalDiscountAmount = 0, netAmount = 0;
                if (dtPurchaseSummary.Tables[1] != null && dtPurchaseSummary.Tables[1].Rows.Count > 0)
                {
                    foreach (DataRow row in dtPurchaseSummary.Tables[1].Rows)
                    {
                ...
                rptItemWisePurchaseSummary.DataDefinition.FormulaFields["SubTotalDiscountAmount"].Text = "'" + subTotalDiscountAmount + "'";
                rptItemWisePurchaseSummary.DataDefinition.FormulaFields["NetAmount"].Text = "'" + netAmount + "'";

                rptItemWisePurchaseSummary.DataDefinition.FormulaFields["Location"].Text = "'" + cmbLocation.Text.Trim() + "'";
                rptItemWisePurchaseSummary.DataDefinition.FormulaFields["DateFrom"].Text = "'" + dtpDateFrom.Text + "'";
                rptItemWisePurchaseSummary.DataDefinition.FormulaFields["DateTo"].Text = "'" + dtpDateTo.Text + "'";
                rptItemWisePurchaseSummary.DataDefinition.FormulaFields["LoginUsername"].Text = "'" + Common.LoggedUserName + "'";
                rptItemWisePurchaseSummary.DataDefinition.FormulaFields["LoginLocation"].Text = "'" + Common.LoggedLocation + "'";
                rptItemWisePurchaseSummary.DataDefinition.FormulaFields["CompanyName"].Text = "'" + Common.CompanyName + "'";
                rptItemWisePurchaseSummary.DataDefinition.FormulaFields["Address"].Text = "'" + Common.Address + "'";
                frmReportViewer.crystalReportViewer.ReportSource = rptItemWisePurchaseSummary;
