...
{
    public partial class FrmReOrderLevel : FrmBaseReport
    {
        ...
        public override void View()
        {
            try
            {
                ...
                RptItemWiseReOrderLevel rptItemWiseReOrderLevel = new RptItemWiseReOrderLevel();
                rptItemWiseReOrderLevel.SummaryInfo.ReportTitle = this.Text;
                DataSet dtReOrderLevel = salesService.GetReOrderLevel(locationId,codeFrom, codeTo);
                rptItemWiseReOrderLevel.SetDataSource(dtReOrderLevel.Tables[0]);


                rptItemWiseReOrderLevel.DataDefinition.FormulaFields["Location"].Text = "'" + cmbLocation.Text.Trim() + "'";
                rptItemWiseReOrderLevel.DataDefinition.FormulaFields["LoginUsername"].Text = "'" + Common.LoggedUserName + "'";
                rptItemWiseReOrderLevel.DataDefinition.FormulaFields["LoginLocation"].Text = "'" + Common.LoggedLocation + "'";
                rptItemWiseReOrderLevel.DataDefinition.FormulaFields["CompanyName"].Text = "'" + Common.CompanyName + "'";
                rptItemWiseReOrderLevel.DataDefinition.FormulaFields["Address"].Text = "'" + Common.Address + "'";
                frmReportViewer.crystalReportViewer.ReportSource = rptItemWiseReOrderLevel;
