...
{
    public partial class FrmBinCard : FrmBaseReport
    {
        public FrmBinCard()
        {
            InitializeComponent();
        ...
        public override void View()
        {
            try
            {
                ...
                RptItemBinCard rptItemBinCard = new RptItemBinCard();
                rptItemBinCard.SummaryInfo.ReportTitle = this.Text;
                DataTable dtBinCard = itemService.BinCardProcess(locationId, dateFrom, dateTo, codeFrom, codeTo);
                rptItemBinCard.SetDataSource(dtBinCard);
                rptItemBinCard.DataDefinition.FormulaFields["Location"].Text = "'" + cmbLocation.Text.Trim() + "'";
                rptItemBinCard.DataDefinition.FormulaFields["DateFrom"].Text = "'" + dtpDateFrom.Text + "'";
                rptItemBinCard.DataDefinition.FormulaFields["DateTo"].Text = "'" + dtpDateTo.Text + "'";
                rptItemBinCard.DataDefinition.FormulaFields["LoginUsername"].Text = "'" + Common.LoggedUserName + "'";
                rptItemBinCard.DataDefinition.FormulaFields["LoginLocation"].Text = "'" + Common.LoggedLocation + "'";
                rptItemBinCard.DataDefinition.FormulaFields["CompanyName"].Text = "'" + Common.CompanyName + "'";
                rptItemBinCard.DataDefinition.FormulaFields["Address"].Text = "'" + Common.Address + "'";
                frmReportViewer.crystalReportViewer.ReportSource = rptItemBinCard;
