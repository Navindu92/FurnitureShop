...
{
    public partial class FrmGivenDateStock : FrmBaseReport
    {
        ...
        public override void View()
        {
            try
            {
                ...
                DateTime dateGivenDate = dtpGivenDate.Value.Date;
                ...
                RptItemGivenDate rptItemGivenDate = new RptItemGivenDate();
                rptItemGivenDate.SummaryInfo.ReportTitle = this.Text;
                DataTable dtGivenDate = itemService.GivenDateStockProcess(locationId, dateGivenDate, codeFrom, codeTo, chkWithoutZero.Checked);
                rptItemGivenDate.SetDataSource(dtGivenDate);
                rptItemGivenDate.DataDefinition.FormulaFields["Location"].Text = "'" + cmbLocation.Text.Trim() + "'";
                rptItemGivenDate.DataDefinition.FormulaFields["GivenDate"].Text = "'" + dtpGivenDate.Text + "'";
                rptItemGivenDate.DataDefinition.FormulaFields["LoginUsername"].Text = "'" + Common.LoggedUserName + "'";
                rptItemGivenDate.DataDefinition.FormulaFields["LoginLocation"].Text = "'" + Common.LoggedLocation + "'";
                rptItemGivenDate.DataDefinition.FormulaFields["CompanyName"].Text = "'" + Common.CompanyName + "'";
                rptItemGivenDate.DataDefinition.FormulaFields["Address"].Text = "'" + Common.Address + "'";
                frmReportViewer.crystalReportViewer.ReportSource = rptItemGivenDate;
