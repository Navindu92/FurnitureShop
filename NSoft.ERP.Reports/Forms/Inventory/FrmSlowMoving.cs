...
{
    public partial class FrmSlowMoving : FrmBaseReport
    {
        ...
        public override void View()
        {
            try
            {
                ...
                RptItemWiseSlowMoving rptItemWiseSlowMoving = new RptItemWiseSlowMoving();
                if (txtItemCodeFrom.Text == string.Empty && txtItemCodeTo.Text == string.Empty)
                {
                    rptItemWiseSlowMoving.SetDataSource(salesService.GetItemWiseSlowMovingDetails(locationId, dateFrom, dateTo));
                }
                else
                {
                    rptItemWiseSlowMoving.SetDataSource(salesService.GetItemWiseSlowMovingDetails(locationId, dateFrom, dateTo, codeFrom, codeTo));
                }
                rptItemWiseSlowMoving.SummaryInfo.ReportTitle = this.Text;
                if (chkAllLocations.Checked)
                { rptItemWiseSlowMoving.DataDefinition.FormulaFields["Location"].Text = "'All Locations'"; }
                else
                { rptItemWiseSlowMoving.DataDefinition.FormulaFields["Location"].Text = "'" + cmbLocation.Text.Trim() + "'"; }
                rptItemWiseSlowMoving.DataDefinition.FormulaFields["DateFrom"].Text = "'" + dtpDateFrom.Text + "'";
                rptItemWiseSlowMoving.DataDefinition.FormulaFields["DateTo"].Text = "'" + dtpDateTo.Text + "'";
                rptItemWiseSlowMoving.DataDefinition.FormulaFields["LoginUsername"].Text = "'" + Common.LoggedUserName + "'";
                rptItemWiseSlowMoving.DataDefinition.FormulaFields["LoginLocation"].Text = "'" + Common.LoggedLocation + "'";
                rptItemWiseSlowMoving.DataDefinition.FormulaFields["CompanyName"].Text = "'" + Common.CompanyName + "'";
                rptItemWiseSlowMoving.DataDefinition.FormulaFields["Address"].Text = "'" + Common.Address + "'";
                frmReportViewer.crystalReportViewer.ReportSource = rptItemWiseSlowMoving;
