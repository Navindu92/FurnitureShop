...
{
    public partial class FrmSalesAnalysis : FrmBaseReport
    {
        ...
        public override void Initialize()
        {
            try
            {
                ...
                Common.SetAutoCompleteWithoutAppend(txtItemCodeFrom, itemService.GetAllActiveItemCodes());
                Common.SetAutoCompleteWithoutAppend(txtItemCodeTo, itemService.GetAllActiveItemCodes());
        ...
        public override void View()
        {
            try
            {
                ...
                RptItemWiseSalesAnalysis rptItemWiseSalesAnalysis = new RptItemWiseSalesAnalysis();

                rptItemWiseSalesAnalysis.SetDataSource(salesService.GetItemWiseSalesAnalysisDetails(locationId, DateTime.Now.Date, codeFrom));

                rptItemWiseSalesAnalysis.SummaryInfo.ReportTitle = this.Text;
                if (chkAllLocations.Checked)
                { rptItemWiseSalesAnalysis.DataDefinition.FormulaFields["Location"].Text = "'All Locations'"; }
                else
                { rptItemWiseSalesAnalysis.DataDefinition.FormulaFields["Location"].Text = "'" + cmbLocation.Text.Trim() + "'"; }
                rptItemWiseSalesAnalysis.DataDefinition.FormulaFields["LoginUsername"].Text = "'" + Common.LoggedUserName + "'";
                rptItemWiseSalesAnalysis.DataDefinition.FormulaFields["LoginLocation"].Text = "'" + Common.LoggedLocation + "'";
                rptItemWiseSalesAnalysis.DataDefinition.FormulaFields["CompanyName"].Text = "'" + Common.CompanyName + "'";
                rptItemWiseSalesAnalysis.DataDefinition.FormulaFields["Address"].Text = "'" + Common.Address + "'";
                frmReportViewer.crystalReportViewer.ReportSource = rptItemWiseSalesAnalysis;
        ...
        {
            return Validater.ValidateTextBox(errorProvider1, ValidateType.Empty, txtItemCodeFrom,txtItemNameFrom);
        }
