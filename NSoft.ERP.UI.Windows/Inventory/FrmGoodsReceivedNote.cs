...
{
    public partial class FrmGoodsReceivedNote : FrmBaseTransation
    {
        ///<summary>
        ...
        public override void FormLoad()
        {
            try
            {
                ...
                dgvGoodsReceivedNote.AutoGenerateColumns = false;
        ...
        public override void Initialize()
        {
            try
            {
                ...
                dgvGoodsReceivedNote.DataSource = null;
                dgvGoodsReceivedNote.DataSource = purchaseTempList;
                dgvGoodsReceivedNote.Refresh();
                ...
                grpMarginWarning.Visible = false;
        ...
        public override void Save()
        {
            try
            {
                ...
                if (dgvGoodsReceivedNote.RowCount == 0)
                {
        ...
        private void dgvGoodsReceivedNote_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                if (dgvGoodsReceivedNote.RowCount > 0)
                {
                    if (dgvGoodsReceivedNote["ItemCode", dgvGoodsReceivedNote.CurrentCell.RowIndex].Value.ToString() == string.Empty) { return; }
                    LoadItem(true, dgvGoodsReceivedNote["ItemCode", dgvGoodsReceivedNote.CurrentCell.RowIndex].Value.ToString());

                    txtCostPrice.Text = Common.ConvertToStringCurrancy(dgvGoodsReceivedNote["CostPrice", dgvGoodsReceivedNote.CurrentCell.RowIndex].Value.ToString());
                    txtSellingPrice.Text = Common.ConvertToStringCurrancy(dgvGoodsReceivedNote["SellingPrice", dgvGoodsReceivedNote.CurrentCell.RowIndex].Value.ToString());
                    txtMargin.Text = Common.ConvertToStringCurrancy(dgvGoodsReceivedNote["Margin", dgvGoodsReceivedNote.CurrentCell.RowIndex].Value.ToString());
                    txtQty.Text = Common.ConvertToStringCurrancy(dgvGoodsReceivedNote["Qty", dgvGoodsReceivedNote.CurrentCell.RowIndex].Value.ToString());
                    txtFreeQty.Text = Common.ConvertToStringCurrancy(dgvGoodsReceivedNote["FreeQty", dgvGoodsReceivedNote.CurrentCell.RowIndex].Value.ToString());
                    txtItemDis.Text = Common.ConvertToStringCurrancy(dgvGoodsReceivedNote["DiscountPercentage", dgvGoodsReceivedNote.CurrentCell.RowIndex].Value.ToString());
                    txtAmount.Text = Common.ConvertToStringCurrancy(dgvGoodsReceivedNote["Amount", dgvGoodsReceivedNote.CurrentCell.RowIndex].Value.ToString());
                    txtQty.SelectAll();
                    txtQty.Focus();
        ...
        private void SaveGoodsReceivedNote(bool isPrintGoodsReceivedNote = true)
        {
            try
            {
                Summarize();
                ...
                if (purchaseService.Save(formInfo, purchaseMain, purchaseTempList, out documentNo))
                {
                    Clear();
                    GenerateGoodsReceivedNoteDocument();
                }
            }
            catch (Exception ex)
            {
        ...
        private void UpdateGrid(PurchaseTemp purchaseTemp)
        {
            try
            {
                ...
                dgvGoodsReceivedNote.DataSource = purchaseTempList.ToList();
                dgvGoodsReceivedNote.Refresh();

                if (dgvGoodsReceivedNote.RowCount > 0)
                {
                    dgvGoodsReceivedNote.ClearSelection();
                    dgvGoodsReceivedNote.Rows[dgvGoodsReceivedNote.RowCount - 1].Selected = true;
                    dgvGoodsReceivedNote.FirstDisplayedScrollingRowIndex = dgvGoodsReceivedNote.RowCount - 1;
        ...
        private void GenerateGoodsReceivedNoteDocument()
        {
            try
            {
        ...
        private void dgvGoodsReceivedNote_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Delete)
                {
                    ...
                    if (dgvGoodsReceivedNote.Rows.Count > 0)
                    {
                        if (dgvGoodsReceivedNote["ItemCode", dgvGoodsReceivedNote.CurrentCell.RowIndex].Value.ToString() == string.Empty) { return; }
                        LoadItem(true, dgvGoodsReceivedNote["ItemCode", dgvGoodsReceivedNote.CurrentCell.RowIndex].Value.ToString());
                        ClearLine();
                        if (SysMessage.ShowMessage(SysMessage.MessageAction.Delete, SysMessage.MessageType.Question, this.Text, dgvGoodsReceivedNote["ItemCode", dgvGoodsReceivedNote.CurrentCell.RowIndex].Value.ToString() + " - " + dgvGoodsReceivedNote["ItemName", dgvGoodsReceivedNote.CurrentCell.RowIndex].Value.ToString()).Equals(DialogResult.No)) { return; };
                        if (item != null)
                        {
                            purchaseTemp = new PurchaseTemp();
                            purchaseTemp.ItemID = item.ItemID;
                            purchaseTemp.CostPrice = Common.ConvertStringToDecimal(dgvGoodsReceivedNote["CostPrice", dgvGoodsReceivedNote.CurrentCell.RowIndex].Value.ToString());
                            purchaseTemp.SellingPrice = Common.ConvertStringToDecimal(dgvGoodsReceivedNote["SellingPrice", dgvGoodsReceivedNote.CurrentCell.RowIndex].Value.ToString());
                        }
        ...
        private void FrmGoodsReceivedNote_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void txtSellingPrice_Leave(object sender, EventArgs e)
        {
            try
            {
                ...
                if (marginPercentage > 50 || marginPercentage < 10)
                {
                    grpMarginWarning.Visible = true;
                    btnOk.Focus();
                }
            }
            catch (Exception ex)
